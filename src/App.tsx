...
// Collaborative editing components (preserving existing features)
const YjsDemo = lazy(() => import('./components/YjsDemo'));
const SimpleScreenplayDemo = lazy(() => import('./components/SimpleScreenplayDemo'));
      ...
      <AuthProvider>
        <Suspense fallback={<LoadingScreen />}>
          <Routes>
            ...
            {/* Collaborative editing examples (preserving existing features) */}
            <Route
              path="/examples/yjs-demo"
              element={<YjsDemo />}
            />
            <Route
              path="/examples/simple-screenplay"
              element={<SimpleScreenplayDemo />}
            />
